...
def create_custom_colormaps() -> Dict[str, Any]:
    ...
    science_colors = [
        (0.00, '#ffffff'),  # 纯白色 (0%, 专业白色背景)
        (0.05, '#e6f3ff'),  # 浅冰蓝 (5%, 极浅冷色)
        (0.15, '#b3d9ff'),  # 天蓝色 (15%, 浅蓝过渡)
        (0.35, '#4a90e2'),  # 专业蓝 (35%, 标准科学蓝)
        (0.50, '#2c5aa0'),  # 深蓝色 (50%, 深度过渡)
        (0.65, '#8b4513'),  # 棕褐色 (65%, 专业暖色)
        (0.80, '#d2691e'),  # 橙棕色 (80%, 高级暖色)
        (1.00, '#8b0000')   # 深红色 (100%, 深色顶峰)
    ]
